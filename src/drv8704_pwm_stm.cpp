 ...
 * @brief STM hardware-PWM backend for DRV8704 PWM input generation.
 */
...
#if defined(ARDUINO_ARCH_STM32) || defined(ARDUINO_ARCH_STM32F1) || defined(ARDUINO_ARCH_STM32L4)
...
class StmPwmBackend : public DRV8704PwmBackend {
public:
  StmPwmBackend() : frequencyHz_(0UL), resolutionBits_(0U) {}
  ...
  bool configure(const DRV8704Pins& pins,
    ...
    capability.backendType = PwmBackendType::StmHardware;
